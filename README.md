...
## Methodology
* **Dataset:** Utilizes the MosMedData dataset, processed into a balanced cohort of 5,000 2D slices (2,500 COVID-positive, 2,500 Normal)[cite: 35].
* **Leak-Free Splitting:** Data was split at the patient level (70% Train, 15% Val, 15% Test) to prevent data leakage[cite: 36].
